...
public class PlanController : ControllerBase
{
    ...
    [HttpPost("RemoveProcedureFromPlan")]
    public async Task<IActionResult> RemoveProcedureFromPlan(DeleteProcedureFromPlanCommand command, CancellationToken token)
    {
        var response = await _mediator.Send(command, token);
