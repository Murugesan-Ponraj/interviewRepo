...
const Plan = () => {
  ...
  const handleAddProcedureToPlan = async (procedure) => {  
    ...
    if (hasProcedureInPlan) {
      console.log(planProcedures.filter((f)=>f.procedureId !== procedure.procedureId));
      setPlanProcedures(planProcedures.filter((f)=>f.procedureId !== procedure.procedureId));
                    ...
                    <div>
                      {planProcedures.map((p) => (
                        <PlanProcedureItem
                          ...
                          users={users}
                          assignedUsers = {p.userPlanProcedureRelations}
                        />
                      ))}
                    </div>
                  </div>
